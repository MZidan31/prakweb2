...
<body>
    ...
    <div class="container">
        <form method="POST" action="form_registrasi.php">
            ...
            <div class="form-group row">
              ...
              <div class="col-8">
                <div class="custom-control custom-radio custom-control-inline">
                  <input name="jk" id="radio_0" type="radio" class="custom-control-input" value="L" checked="checked"> 
            ...
            <div class="form-group row">
              <label for="emial" class="col-4 col-form-label">email</label> 
              <div class="col-8">
                <div class="input-group">
                  <div class="input-group-prepend">
                    <div class="input-group-text">
...
<?php
//ambil data yang diinput user berdasar nickname nya
//fungsi isset digunakan untuk memeriksa apakah variable sudah diisi atau sudah diatur atau belum
